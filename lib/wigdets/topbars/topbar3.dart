...
class TopBarContents3 extends StatefulWidget {
  final double opacity;

  const TopBarContents3(this.opacity, {Key? key}) : super(key: key);

  @override
  _TopBarContentsState createState() => _TopBarContentsState();
}

class _TopBarContentsState extends State<TopBarContents3> {
  @override
              ...
              child: Row(
                ...
                children: [
                  ...
                  getHeaderText(Icons.settings, 'Skills & Services', 1,
                      (value) {
                    setState(() {
                      value ? _isHovering[1] = true : _isHovering[1] = true;
                    });
                  }, () {
