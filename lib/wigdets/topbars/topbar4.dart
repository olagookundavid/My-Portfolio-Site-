...
class TopBarContents4 extends StatefulWidget {
  final double opacity;

  const TopBarContents4(this.opacity, {Key? key}) : super(key: key);

  @override
  _TopBarContentsState createState() => _TopBarContentsState();
}

class _TopBarContentsState extends State<TopBarContents4> {
  @override
              ...
              child: Row(
                ...
                children: [
                  ...
                  getHeaderText(Icons.work, 'My Works', 2, (value) {
                    setState(() {
                      value ? _isHovering[2] = true : _isHovering[2] = true;
                    });
                  }, () {
