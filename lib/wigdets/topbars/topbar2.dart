...
class TopBarContents2 extends StatefulWidget {
  final double opacity;

  const TopBarContents2(this.opacity, {Key? key}) : super(key: key);

  @override
  _TopBarContentsState createState() => _TopBarContentsState();
}

class _TopBarContentsState extends State<TopBarContents2> {
  @override
              ...
              child: Row(
                ...
                children: [
                  ...
                  getHeaderText(Icons.person, 'About Me', 0, (value) {
                    setState(() {
                      value ? _isHovering[0] = true : _isHovering[0] = true;
                    });
                  }, () {}),
                  const Spacer(),
